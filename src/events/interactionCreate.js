      ...
      try {
        ...
        if (interaction.isChatInputCommand()) {
          try {
            ...
            const normalizedCategory = String(command.category || '')
              .trim()
              .toLowerCase();
            ...
            const categoryEnabled =
              normalizedCategory === 'music'
                ? botConfig.features?.music === true &&
                  botConfig.features?.voice === true
                : normalizedCategory === 'voice'
                  ? botConfig.features?.voice === true
                  : isCommandCategoryEnabled(command.category);

            logger.info('Final category access check:', {
              commandName: interaction.commandName,
              originalCategory: command.category,
              normalizedCategory,
              categoryEnabled,
              musicEnabled: botConfig.features?.music,
              voiceEnabled: botConfig.features?.voice,
            });
